...
- `KAN__recovery-manifest__KAN.md` — этот manifest;
...
Профильные approved-источники, включая `blagopoluchie-concept-core-v02-approved.md`, подключаются только под конкретную задачу.
...
8. Подключать профильные источники только по задаче.
9. Не продолжать автоматически старые исследования.

## Подтверждённое состояние проекта

Миграция Project Sources и верхней инструкции проекта v2 проверена КООРДИНАТОРОМ:

`project_sources_migration: verified_complete`

Пакет КАНЦЕЛЯРА приведён к утверждённому recovery-канону v1.2 и синхронизирован с завершённой миграцией.
