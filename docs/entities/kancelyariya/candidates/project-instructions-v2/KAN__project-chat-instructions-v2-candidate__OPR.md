# Инструкции проекта «ШТАБ БЛАГОПОЛУЧИЯ» — кандидат v2
...
`inbox` Сущности не является конечной точкой доставки.

Если артефакт предназначен другой Сущности, маршрут завершается только когда файл фактически загружен в адресный чат либо зафиксирована конкретная причина недоставки и следующий шаг.
